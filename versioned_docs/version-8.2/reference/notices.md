...
This means if you use Tasklist 8.2.0 or 8.2.1 and if you store sensible data that is stored in process variables, which are accessed by User Tasks, then this data could have been accessed to users knowing your endpoint of the task list instance.
